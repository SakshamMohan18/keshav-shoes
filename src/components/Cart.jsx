        ...
        >
          ...
          {cartItems?.length === 0 ? <CartEmpty onCartToggle={onCartToggle} /> : <div>
            ...
            <div className="fixed bottom-0 bg-white w-full px-5 py-2 grid items-center">
              ...
              <p className="text-sm font-medium text-center">Visit Store for Purchase</p>
              <p className="text-sm font-medium text-center">Located at : Kishanpura, Pull Jogiyan, Saharanpur</p>
              </div>
            </div>
          </div>}
        </div>
